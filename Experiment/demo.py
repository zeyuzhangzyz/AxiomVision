## This is an example of modifying different model's source code to analyze both time and accuracy together.
# The inference times of various models were recorded and saved in a txt file. Based on their accuracy and inference time, appropriate cascade grouping was performed.
...
# save the root directory of the current directory
...
#  change box format to yolo format
...
def run_demo(cfg, ckpt, score_threshold, images_dir, output_dir, dataset_type, save_img, video_file):
    ...
    if videofile == 'none':
        ...
        with open(file_path, "a+") as file:
            file.write(f"{total_time},{total_time}, {os.path.basename(video_file)}, ssd\n")
    else:
        if videofile.endswith(".mp4") or videofile.endswith(".avi"):
            video_path = os.path.join(video_folder, videofile)
            cap = cv2.VideoCapture(video_path)
...
if __name__ == '__main__':
    main()
    # two examples
    # python D:/code/PycharmProjects/SSD/demo.py  --project D:/code/PycharmProjects/SSD/runs/  --name 002 --images_dir D:/code/PycharmProjects/MM/source/0_10
    # python D:/code/PycharmProjects/SSD/demo.py  --project D:/code/PycharmProjects/SSD/runs/  --name 002 --videofile D:/code/PycharmProjects/MM/source/0_10.mp4
